...
void HAL_TIM_PWM_MspDeInit(TIM_HandleTypeDef* htim_pwm)
{
  if(htim_pwm->Instance==TIM1)
  {
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, M1_DP_Pin|M1_PWM_UL_Pin|M1_PWM_UH_Pin|M1_PWM_VH_Pin
                          |M1_PWM_WH_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PC11     ------> USART3_RX  // NOTE: This was PB11 in the original UART3 config. Ensure HW wiring matches.
    PB9     ------> USART3_TX
    */
