...
#define LS                      0.0002 /* Stator inductance, H
...
#define MOTOR_VOLTAGE_CONSTANT  21.8 /*!< Volts RMS ph-ph /kRPM */
#define MOTOR_MAX_SPEED_RPM     1254 /*!< Maximum rated speed  */
#define NOMINAL_CURRENT_A       12

#define ID_DEMAG_A              -12 /*!< Demagnetization current */
