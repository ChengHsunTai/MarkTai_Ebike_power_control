...
#define MAX_APPLICATION_SPEED_RPM           1254 /*!< rpm, mechanical */
...
#define PLL_KP_GAIN                         834
#define PLL_KI_GAIN                         74
...
#define PID_TORQUE_KP_DEFAULT               3063
#define PID_TORQUE_KI_DEFAULT               2174
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 3063
...
#define PID_SPEED_KP_DEFAULT                8000/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                30/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            452
#define DEFAULT_TARGET_SPEED_UNIT           (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)
#define DEFAULT_TORQUE_COMPONENT_A          0
#define DEFAULT_FLUX_COMPONENT_A            0

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V              49 /*!< Over-voltage threshold */
#define UD_VOLTAGE_THRESHOLD_V              6 /*!< Under-voltage threshold */
